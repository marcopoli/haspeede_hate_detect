...
random_grid = {
        ...
        'hidden_layer_sizes': randint(500, 3000),
...
#rf_random = RandomizedSearchCV(estimator = rf, param_distributions = random_grid, n_iter = 70, cv = 3, verbose=2, random_state=34456, n_jobs = -1, scoring='f1')
# Fit the random search model

#rf_random.fit(x_embeddings_tf_train, y)
rf_random = joblib.load("01.MLP_embeddingsText.pkl")
#joblib.dump(rf_random.best_estimator_, "01.MLP_embeddingsText.pkl")
